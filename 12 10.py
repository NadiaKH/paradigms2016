...
def testBinOper_1():
    ...
    assert 10 == UnaryOperation('-',(BinaryOperation(B, '-', A))).evaluate(parent).value
...
def testBinOper_3():
    parent = Scope()
    parent['N'] = BinaryOperation(Number(6), '+', BinaryOperation(Number(7), '>', Number(8))).evaluate(parent)
...
def testCond_3():
    ...
    F1 = FunctionDefinition('F1', Function(('a', 'b'),
                                           [Print(BinaryOperation(Reference('a'),
                                                                  '+',
                                                                  Reference('b')))]))
    F2 = FunctionDefinition('F2',Function(('a', 'b'), [Print(BinaryOperation(Reference('a'),
                                                                             '+',
                                                                             Reference('b')))]))
...
def testCond_4():
    ...
    Cond_2 = Conditional(Number(0), [Print(Reference('a'))], [Print(Reference('b'))])
